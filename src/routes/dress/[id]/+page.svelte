...
<article class="mx-auto p-6 justify-center">
  ...
  <div class="grid grid-cols-3 items-center justify-center gap-5">
    ...
    <!-- Thumbnails -->
    <div class="hidden lg:flex flex-col gap-4 w-24 items-center justify-center mx-auto">
    ...
    <!-- Dress Details -->
    <div class="space-y-6 self-start flex justify-baseline">
      <section>
